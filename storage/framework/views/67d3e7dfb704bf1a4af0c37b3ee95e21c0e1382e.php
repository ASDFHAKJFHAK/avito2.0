			...
			<div class="row">
				<div class="col-12 ">
					...
					<div class=" d-flex justify-content-between">
						...
						<form action="<?php echo e(route('post.destroy', ['post' => $post->id])); ?>" method="POST">
	 						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\learnLaravel\resources\views/post_delete.blade.php ENDPATH**/ ?>