...
<select name="categori_id" class="form-select form-select-lg mb-3" aria-label=".form-select-lg пример">
  <option selected value="0">Категория товара не выбрана</option>
